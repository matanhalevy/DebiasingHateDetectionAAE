...
do
    ...
    python run_model.py --do_eval --do_lower_case --data_dir ./data/nyt_data/nyt_keyword_sample/ --bert_model bert-base-uncased --max_seq_length 128 --train_batch_size 32 --learning_rate 2e-5 --num_train_epochs 5 --output_dir runs/${model_path}_seed_${current_seed} --seed ${current_seed} --task_name nyt --test ${extra_args}
    python run_model.py --do_eval --do_lower_case --data_dir ./data/twitter/ --bert_model bert-base-uncased --max_seq_length 128 --train_batch_size 32 --learning_rate 2e-5 --num_train_epochs 5 --output_dir runs/${model_path}_seed_${current_seed} --seed ${current_seed} --task_name twitter --test ${extra_args}
    let current_seed++
done
